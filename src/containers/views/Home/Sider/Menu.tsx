...
@inject('routerStore', 'globalStore')
@observer
class SiderMenu extends React.Component<IProps> {
    ...
    @computed
    get menuTree() {
        return arrayToTree<IMenuInTree>(menu)
    }

    @computed
    get menuProps() {
        const { sideBarCollapsed, navOpenKeys } = this.props.globalStore
    ...
    onOpenChange = (openKeys: string[]): void => {
        const { navOpenKeys, setOpenKeys } = this.props.globalStore
